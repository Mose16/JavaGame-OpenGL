...
public class Renderer {
	...
	public void prepare() {
		...
		GL11.glClear(GL11.GL_COLOR_BUFFER_BIT); //Not sure, clears it I guess
	}
	...
	public void render(RawModel model) { //'RawModel' in replace of 'int', 'float' or the like
		...
		GL11.glDrawArrays(GL11.GL_TRIANGLES, 0, model.getVertexCount()); //Draw the triangles based on the VAO starting at position '0' in the Attrib array (VBO~)
